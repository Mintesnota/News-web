                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="settings">
                                        ...
                                        <form action="{{route('admin.user.update.form', $user->id??'')}}" method="POST" class="form-horizontal">
                                            @csrf
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text " class="form-control" name="profesion" value="{{$user->profesion??''}}" placeholder="Your profession">
                                                </div>
                                            </div>
