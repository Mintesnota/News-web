                ...
                <div class="card card-primary">
                  ...
                  <div class="row">
                     ...
                     <div class="form-group">
                         ...
                         <div class="form-group">
                           <label for="short_desc">Post cover Image</label>
                           <input type="file" name="image" class="form-control">

                               </div>
                        <div class="form-group">
                        <label for="short_desc">Short Description</label>
                        <textarea name="short_desc" class="form-control" id="editor1" >{{$post->short_desc}}</textarea>

                      </div>

                      <div class="form-group">
                        <label for="long_desc">Long Description</label>
                        <textarea name="long_desc" class="form-control" id="editor2">{{$post->long_desc}}</textarea>
